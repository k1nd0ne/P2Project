...
public class RefreshRegistration extends TimerTask{
	...
	public void run() {
		...
		for (String filename : fileList) {
			if(filename.contains(".part")) {
				...
				reg.setServer(""); //The master will bind the address. Why ? Because I can't find a way to get a proper local IP adress.
	...
	/**
	 * Split a file into 10 parts of sizeof(file)/10.
